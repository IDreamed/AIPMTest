...
export const learningRecords = [
  { time: "今天 14:20", title: "数学基础强化", detail: "视频课时：函数概念与表示，学习时长 18 分钟。", status: "已完成" },
  { time: "昨天 19:40", title: "英语阅读提分", detail: "音频课时：阅读定位方法，学习时长 12 分钟。", status: "已完成" },
  { time: "04-24 20:10", title: "数据库基础", detail: "视频课时：E-R 模型与关系判断，已学 60%。", status: "学习中" },
];

export const wrongQuestions = [
  { title: "函数值计算题", subject: "数学", source: "试卷", point: "函数", status: "未掌握", detail: "我的答案 B，正确答案 C", answer: "C. 7", analysis: "将 x=3 代入 f(x)=2x+1，得到 7。" },
  { title: "E-R 模型判断", subject: "电子与信息类", source: "考试", point: "数据库", status: "已掌握", detail: "考试联考第 8 题", answer: "A. 多对多", analysis: "一个学生可选多门课程，一门课程也可被多名学生选择。" },
  { title: "一次函数图像识别", subject: "数学", source: "课程", point: "函数图像", status: "未掌握", detail: "课堂练习第 3 题", answer: "B. 过第一、三象限", analysis: "k>0 时函数图像随 x 增大而增大。" },
  { title: "等差数列通项", subject: "数学", source: "试卷", point: "数列", status: "未掌握", detail: "数学基础模拟卷第 12 题", answer: "A. a1+(n-1)d", analysis: "等差数列通项公式为 a_n=a_1+(n-1)d。" },
  { title: "阅读主旨判断", subject: "英语", source: "试卷", point: "阅读理解", status: "未掌握", detail: "英语阅读提升卷第 5 题", answer: "D. The main purpose", analysis: "主旨题优先看首尾段和重复出现的核心词。" },
  { title: "完形填空语境", subject: "英语", source: "课程", point: "完形填空", status: "已掌握", detail: "音频课后练习第 2 题", answer: "B. however", analysis: "前后句存在转折关系，应选择 however。" },
  { title: "病句辨析", subject: "语文", source: "试卷", point: "语病", status: "未掌握", detail: "语文基础模拟卷第 8 题", answer: "C. 搭配不当", analysis: "动宾搭配不成立，需要调整谓语或宾语。" },
  { title: "应用文格式", subject: "语文", source: "课程", point: "应用文", status: "已掌握", detail: "写作课后练习第 1 题", answer: "A. 称呼顶格", analysis: "通知、申请等文体需按固定格式书写。" },
  { title: "SQL 查询条件", subject: "电子与信息类", source: "课程", point: "SQL", status: "未掌握", detail: "数据库基础课时练习第 4 题", answer: "C. WHERE", analysis: "筛选记录使用 WHERE 子句。" },
  { title: "网络协议层次", subject: "电子与信息类", source: "考试", point: "计算机网络", status: "未掌握", detail: "班级测试第 18 题", answer: "B. 网络层", analysis: "IP 协议工作在网络层。" },
  { title: "古诗词意象", subject: "语文", source: "考试", point: "古诗词", status: "未掌握", detail: "公开测评第 6 题", answer: "D. 思乡", analysis: "月、归雁等意象常与思乡情感相关。" },
  { title: "不等式求解", subject: "数学", source: "考试", point: "不等式", status: "已掌握", detail: "学校联考第 14 题", answer: "B. x>2", analysis: "移项并合并同类项后得到解集。" },
];
